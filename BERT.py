...
def plot_graphs(history, string):
    ...
    plt.show()
    #base_path = 'C:/Users/PC/Desktop/NLP/DACON/image'
    #img_names = [ base_path + str(img_number) + ".jpg"  for img_number in range(1,73)]
    #plt.savefig('img_names')
...
submission.to_csv('bert_baseline_30.csv', index=False)
